    ...
    try {
        ...
        if (m.message) {
            ...
            if (m.msg) {
                ...
                const tagMention = m.msg.contextInfo != null ? m.msg.contextInfo.mentionedJid : [];
                ...
                if (m.quoted) {
                    ...
                    const quoted_quotedMention = m.quoted.msg.contextInfo != null ? m.quoted.msg.contextInfo.participant : '';
                    const quoted_tagMention = m.quoted.msg.contextInfo != null ? m.quoted.msg.contextInfo.mentionedJid : [];
